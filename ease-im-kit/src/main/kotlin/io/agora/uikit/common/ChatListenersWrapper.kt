...
import io.agora.uikit.common.ChatMultiDeviceListener.CONTACT_ACCEPT
import io.agora.uikit.common.ChatMultiDeviceListener.CONTACT_REMOVE
import io.agora.uikit.common.ChatMultiDeviceListener.GROUP_CREATE
import io.agora.uikit.common.ChatMultiDeviceListener.GROUP_DESTROY
import io.agora.uikit.common.ChatMultiDeviceListener.GROUP_JOIN
import io.agora.uikit.common.ChatMultiDeviceListener.GROUP_LEAVE
import io.agora.uikit.EaseIM
import io.agora.uikit.common.bus.EaseFlowBus
import io.agora.uikit.common.extensions.createUnsentMessage
    ...
    override fun onMessageRecalled(messages: MutableList<ChatMessage>) {
        if (messages.isNotEmpty()){
            ...
            chatMessageListener.let {
                try {
                    for (messageListener in it) {
                        messageListener.onMessageRecalled(messages)
                    }
                } catch (e: Exception) {
                    e.printStackTrace()
                }
