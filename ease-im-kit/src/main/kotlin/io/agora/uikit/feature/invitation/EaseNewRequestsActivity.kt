...
import io.agora.uikit.common.extensions.getInviteMessageStatus
import io.agora.uikit.common.extensions.hasRoute
import io.agora.uikit.databinding.EaseLayoutNewRequestBinding
import io.agora.uikit.feature.contact.interfaces.IEaseContactResultView
import io.agora.uikit.feature.invitation.adapter.EaseRequestAdapter
...
import io.agora.uikit.viewmodel.request.EaseNotificationViewModel
import io.agora.uikit.viewmodel.request.INotificationRequest
...
open class EaseNewRequestsActivity : EaseBaseActivity<EaseLayoutNewRequestBinding>(),
    ...
    private fun showAddContactDialog(){
        val contactDialog = CustomDialog(
            ...
            subtitle = resources.getString(R.string.ease_conv_dialog_add_contact),
            inputHint = resources.getString(R.string.ease_dialog_edit_input_id_hint),
            isEditTextMode = true,
