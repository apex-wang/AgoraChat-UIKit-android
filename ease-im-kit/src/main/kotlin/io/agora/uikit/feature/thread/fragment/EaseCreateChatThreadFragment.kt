...
import io.agora.uikit.databinding.EaseFragmentThreadCreateBinding
import io.agora.uikit.feature.chat.EaseChatFragment
import io.agora.uikit.feature.chat.chathistory.EaseChatHistoryAdapter
...
import io.agora.uikit.feature.chat.widgets.EaseChatVoiceRecorderDialog
import io.agora.uikit.feature.thread.EaseChatThreadActivity
import io.agora.uikit.feature.thread.controllers.EaseChatThreadAttachmentController
import io.agora.uikit.feature.thread.controllers.EaseChatThreadController
...
import io.agora.uikit.menu.chat.EaseChatExtendMenuDialog
...
open class EaseCreateChatThreadFragment: EaseBaseFragment<EaseFragmentThreadCreateBinding>(),
     ...
     */
    private val chatThreadController: EaseChatThreadController by lazy {
        EaseChatThreadController(mContext, threadViewModel) }


    private val attachmentController: EaseChatThreadAttachmentController by lazy {
        EaseChatThreadAttachmentController(mContext, this, conversationId, sendOriginalImage)
    }
    ...
    override fun getViewBinding(
        ...
        container: ViewGroup?
    ): EaseFragmentThreadCreateBinding {
        return EaseFragmentThreadCreateBinding.inflate(inflater)
    }
    ...
    override fun initViewModel() {
        super.initViewModel()
        threadViewModel = ViewModelProvider(this)[EaseChatThreadViewModel::class.java]
    ...
    open fun defaultTitleBar(){
        binding?.run {
            ...
            titleBar.setSubtitle(getString(R.string.ease_thread_affiliation_group,getParentName()))
        }
    }
    ...
    fun onExtendMenuItemClick(view: View?, itemId: Int): Boolean {
        ...
        when(itemId) {
            ...
            R.id.extend_item_contact_card -> {
                attachmentController.selectContact(childFragmentManager, EaseChatType.GROUP_CHAT)
                return true
            }
        }
        return false
    ...
    class Builder(
        ...
        protected var customFragment: EaseCreateChatThreadFragment? = null
        private var recordTouchListener: OnChatRecordTouchListener? = null
        private var backPressListener: View.OnClickListener? = null
        private var extendMenuItemClickListener: OnChatExtendMenuItemClickListener? = null
        ...
        /**
         * Set custom fragment which should extends EaseCreateChatThreadFragment
         *
         * @param fragment
         * @param <T>
         * @return
        </T> */
        fun <T : EaseCreateChatThreadFragment?> setCustomFragment(fragment: T): Builder {
        ...
        fun build(): EaseCreateChatThreadFragment? {
            val fragment = if (customFragment != null) customFragment else EaseCreateChatThreadFragment()
            fragment?.let {
                it.arguments = bundle
    ...
    companion object{
        private val TAG = EaseCreateChatThreadFragment::class.java.simpleName
    }
