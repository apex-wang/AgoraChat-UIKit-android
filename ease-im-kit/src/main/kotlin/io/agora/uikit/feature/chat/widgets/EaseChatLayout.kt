...
import io.agora.uikit.feature.chat.controllers.EaseChatDialogController
import io.agora.uikit.feature.chat.controllers.EaseChatMessageEditController
import io.agora.uikit.feature.chat.controllers.EaseChatMessageMultipleSelectController
import io.agora.uikit.feature.chat.controllers.EaseChatMessageReplyController
import io.agora.uikit.feature.chat.controllers.EaseChatMessageReportController
import io.agora.uikit.feature.chat.controllers.EaseChatMessageTranslationController
import io.agora.uikit.feature.chat.controllers.EaseChatNotificationController
import io.agora.uikit.feature.chat.controllers.EaseChatPinMessageController
import io.agora.uikit.feature.chat.enums.getConversationType
import io.agora.uikit.feature.chat.forward.EaseMessageForwardDialogFragment
import io.agora.uikit.feature.chat.interfaces.ChatInputMenuListener
import io.agora.uikit.feature.chat.interfaces.IChatLayout
import io.agora.uikit.feature.chat.interfaces.IChatMenu
import io.agora.uikit.feature.chat.interfaces.IHandleChatResultView
import io.agora.uikit.feature.chat.interfaces.OnWillSendMessageListener
import io.agora.uikit.feature.chat.interfaces.OnChatErrorListener
import io.agora.uikit.feature.chat.interfaces.OnChatFinishListener
import io.agora.uikit.feature.chat.interfaces.OnChatLayoutListener
...
import io.agora.uikit.feature.chat.interfaces.OnMultipleSelectRemoveMsgListener
import io.agora.uikit.feature.chat.interfaces.OnReactionMessageListener
import io.agora.uikit.feature.chat.interfaces.OnRecallMessageResultListener
import io.agora.uikit.feature.chat.interfaces.OnReportMessageListener
import io.agora.uikit.feature.chat.interfaces.OnTranslationMessageListener
import io.agora.uikit.feature.chat.reply.interfaces.OnMessageReplyViewClickListener
import io.agora.uikit.feature.thread.EaseCreateChatThreadActivity
...
import io.agora.uikit.interfaces.OnVoiceRecorderClickListener
...
import io.agora.uikit.viewmodel.messages.EaseChatViewModel
            ...
            if (messages.isNotEmpty()){
                for (message in messages) {
                    message.let {
                        ...
                        val pinMessage:ChatMessage? = ChatClient.getInstance().chatManager().getMessage(it.msgId)
